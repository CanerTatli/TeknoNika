...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Expense>(entity =>
            {
                ...
                entity.Property(e => e.ElectricBills).HasColumnType("money");

                entity.Property(e => e.EmployeeSalary).HasColumnType("money");

                entity.Property(e => e.ExpenseDate).HasColumnType("date");

                entity.Property(e => e.TechnicalInfrastructure).HasColumnType("money");

                entity.Property(e => e.WaterBills).HasColumnType("money");
            });
            ...
            modelBuilder.Entity<ProductSale>(entity =>
            {
                ...
                entity.HasOne(d => d.Employee)
                    ...
                    .HasConstraintName("FK_ProductSales_Employees");
